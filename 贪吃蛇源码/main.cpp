...
#define GAMETIME 120			//游戏速度
#define LIZINUM 30				//粒子数量
...
void drawlizi() {
	setfillcolor(COLORREF RGB(180, 180, 180)); setlinecolor(COLORREF RGB(180, 180, 180));
	for (int i = 0; i < LIZINUM; i++) {
